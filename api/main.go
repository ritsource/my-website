...
func main() {
	...
	r.HandleFunc("/admin/blog/{id}", middleware.CheckAuth(routes.ReadBlogByID)).Methods("GET")
	...
	r.HandleFunc("/admin/project/{id}", middleware.CheckAuth(routes.ReadProjectByID)).Methods("GET")
	...
	r.HandleFunc("/public/blog/doc/{id}", routes.PubGetBlogDocument).Methods("GET")
	r.HandleFunc("/public/project/doc/{id}", routes.PubGetProjectDocument).Methods("GET")

	r.HandleFunc("/public/blog/all", routes.PubReadBlogs).Methods("GET")
	r.HandleFunc("/public/blog/{id}", routes.PubReadBlogByID).Methods("GET")
	r.HandleFunc("/public/project/all", routes.PubReadProjects).Methods("GET")
	r.HandleFunc("/public/project/{id}", routes.PubReadProjectByID).Methods("GET")
